...
6. **Critério de Aceite:** O *merge* da ramificação só será liberado (*Merge Block*) se o *runner* reportar sucesso na suíte de testes, reduzindo o risco de que código novo quebre regras já validadas.
